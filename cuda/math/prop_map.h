...
struct dir_t{
	...
	//Real hc;     /**<Conjugation of lenslet. Removed from parameter. Only useful for multi-sublayer raytracing. Lenslet is in collimated space for guide star in focus.*/
