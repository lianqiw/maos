...
/**
 * \page algorithm
	\section sect-dm-actuator DM Actuator Influence Function
	\subsubsection sect-dm-linear Linear influence function
...
\subsubsection sect-dm-cubic Cubic influence function
