...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    kalman->Fd=mx2d(mxGetField(prhs[P_KALMAN],0,"Fd"));
    kalman->Cd=mx2d(mxGetField(prhs[P_KALMAN],0,"Cd"));
    kalman->AdM=mx2d(mxGetField(prhs[P_KALMAN],0,"AdM"));
    kalman->FdM=mx2d(mxGetField(prhs[P_KALMAN],0,"FdM"));
    kalman->M=mx2d(mxGetField(prhs[P_KALMAN],0,"M"));
    kalman->P=mx2d(mxGetField(prhs[P_KALMAN],0,"P"));
    kalman->dthi=(double)mxGetScalar(mxGetField(prhs[P_KALMAN],0,"dthi"));
    kalman->dtrat=(int)mxGetScalar(mxGetField(prhs[P_KALMAN],0,"dtrat"));
    kalman->Gwfs=mx2d(mxGetField(prhs[P_KALMAN],0,"Gwfs"));
    kalman->Rwfs=mx2d(mxGetField(prhs[P_KALMAN],0,"Rwfs"));
