...
dsp* mkh(loc_t* locin, loc_t* locout, double displacex, double displacey, double scale, double angle);
dsp* mkh_cubic(loc_t* locin, loc_t* locout, double displacex, double displacey, double scale, double angle, double cubic_iac);
...
dsp* mkg(loc_t* xloc, loc_t* ploc, dmat* amp, loc_t* saloc, dmat *saa, double saat, double scale, double dispx, double dispy, int do_partial);
