...
case $D in
	...
	;;
    30)
		REF_GPU=(1712.96 113.49 113.67 137.24 144.25 138.73 142.56 139.84 122.64 870.72 883.83 112.09 112.93 128.24 141.16 346.33 364.74 123.72 140.29 117.31 117.08 144.60 196.67 197.08 92.09) #2022-03-08 Geforce
