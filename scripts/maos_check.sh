...
case $D in
	...
	;;
    30)	
	REF_GPU=(1819.6 119.2 120.9 125.5 123.1 144.1 127.9 367.5 388.1 814.0 823.5 128.6 125.8 131.5 145.5 151.8 132.2 129.6 155.5 156.8 156.5 160.4 162.8 156.8 156.8 158.2 0.6 53.7 220 159.7) #2025-04-24 kepler D=30
