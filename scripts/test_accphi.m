...
draw(loc, map2loc);
title('map2loc');
hold on; plot(locin(:,1),locin(:,2),'c.');
subplot(2,3,2)
...
title('cubic_loc2loc-map2loc');
subplot(2,3,2)
draw(loc, cubic_map2loc-cubic_loc2loc);
title('cubic_map2loc-cubic_loc2loc');
subplot(2,3,3)
draw(loc, cubic_locmap2loc-cubic_loc2loc);
title('cubic_locmap2loc-cubic_loc2loc');
subplot(2,3,4)
draw(loc, cubic_h-cubic_loc2loc);
title('cubic_h-cubic_loc2loc');
subplot(2,3,5)
draw(loc, cubic_h-h)
title('cubic_h-h');