...
typedef struct proc_t{
  ...
  time_t tlast;//time of last update from host
  //time_t timstart;//job added time
  //time_t timlast;//job last status change time
	struct proc_t* next;
}proc_t;
...
extern GdkPixbuf *icon_save;
extern GdkPixbuf* icon_skip;
extern GdkPixbuf *icon_clear;
extern GdkPixbuf *icon_connect;
//extern GtkWidget* textscroll;
